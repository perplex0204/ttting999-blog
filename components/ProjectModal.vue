          ...
          <div class="p-8">
            ...
            <div class="mb-6">
              ...
              <div
                ...
                class="inline-flex items-center gap-2 px-3 py-1 mb-4 bg-accent-100 dark:bg-accent-900/30 text-accent-700 dark:text-accent-300 rounded-full text-sm font-semibold"
              >
