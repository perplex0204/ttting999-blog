    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div class="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
        ...
        <div class="flex items-center space-x-6">
          ...
          <a
            :href="`mailto:${email}`"
            class="group flex items-center space-x-2 text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors duration-200"
            aria-label="Email"
          >
            <svg
            ...
            <span class="text-sm hidden sm:inline">Email</span>
          </a>
